...
function initialize_state {
    ...
    "destroy")
        ...
        ;;
    "state rm")
	echo "downloading tfstate and calling other"
	download_tfstate
        other
	upload_tfstate
	;;
...
function other {
    ...
    export state_filename="${TF_DATA_DIR}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_name}"
    echo "state_filename: '${state_filename}'"
    ls -la ${state_filename}

    echo "tfstate from plan ======================="
    echo " -state: ${TF_DATA_DIR}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_name}"
